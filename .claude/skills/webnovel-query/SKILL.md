...
**快速分析**：
```bash
python "${SCRIPTS_DIR}/status_reporter.py" --focus urgency --project-root "$PROJECT_ROOT"
```
...
**快速分析**：
```bash
python "${SCRIPTS_DIR}/status_reporter.py" --focus strand --project-root "$PROJECT_ROOT"
```
